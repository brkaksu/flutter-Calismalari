...
class FormSelectionOgeleri extends StatefulWidget {
  @override
  _FormSelectionOgeleriState createState() => _FormSelectionOgeleriState();
}

class _FormSelectionOgeleriState extends State<FormSelectionOgeleri> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title:Text("Form Input Ogeleri")),
      body: Padding(
